...
# README - Proyecto VR: _El Misterio: "El Último Brindis en la Suite 602"_
...
_"El Último Brindis en la Suite 602"_ es un prototipo de juego de misterio en VR desarrollado en **Unity 6**, diseñado para sumergir al jugador en una experiencia de investigación de crimen tipo **Cine Noir**.  
